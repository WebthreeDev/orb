        ...
        667: function(e, r, n) {
            ...
            var b = function e(r) {
                ...
                function C(e, r) {
                    ...
                    if (!(w instanceof C)) return new C(e, r);
                    if (null == r) {
                        ...
                        if (d(r, 2, T.length, "Base"), 10 == r) return F(w = new C(e), S + w.e + 1, R);
                        if (p = String(e), h = "number" == typeof e) {
                            if (0 * e != 0) return y(w, p, h, r);
                            if (w.s = 1 / e < 0 ? (p = p.slice(1), -1) : 1, C.DEBUG && p.replace(/^0\.0*|\./, "").length > 15) throw Error(u + e)
                        } else w.s = 45 === p.charCodeAt(0) ? (p = p.slice(1), -1) : 1;
                        for (n = T.slice(0, r), f = a = 0, g = p.length; a < g; a++)
                    ...
                    if (p = p.slice(a, ++g)) {
                        if (g -= a, h && C.DEBUG && g > 15 && (e > c || e !== o(e))) throw Error(u + w.s * e);
                ...
                function M(e, r, n, t) {
                    var i, o, s, u, f;
                    if (null == n ? n = R : d(n, 0, 8), !e.c) return e.toString();
                    if (i = e.c[0], s = e.e, null == r) f = w(e.c), f = 1 == t || 2 == t && (s <= _ || s >= D) ? N(f, s) : O(f, s, "0");
                    else if (o = (e = F(new C(e), r, n)).e, u = (f = w(e.c)).length, 1 == t || 2 == t && (r <= o || o <= _)) {
                        for (; u < r; f += "0", u++);
                        f = N(f, o)
                ...
                function k(e, r) {
                    for (var n, t = 1, i = new C(e[0]); t < e.length; t++) {
                        if (!(n = new C(e[t])).s) {
                            i = n;
                            break
                        }
                ...
                function j(e) {
                    var r, n = e.e;
                    return null === n ? e.toString() : (r = w(e.c), r = n <= _ || n >= D ? N(r, n) : O(r, n, "0"), e.s < 0 ? "-" + r : r)
                }
                return C.clone = e, C.ROUND_UP = 0, C.ROUND_DOWN = 1, C.ROUND_CEIL = 2, C.ROUND_FLOOR = 3, C.ROUND_HALF_UP = 4, C.ROUND_HALF_DOWN = 5, C.ROUND_HALF_EVEN = 6, C.ROUND_HALF_CEIL = 7, C.ROUND_HALF_FLOOR = 8, C.EUCLID = 9, C.config = C.set = function(e) {
                    ...
                    if (null != e) {
                        ...
                        if (e.hasOwnProperty(r = "DECIMAL_PLACES") && (d(n = e[r], 0, g, r), S = n), e.hasOwnProperty(r = "ROUNDING_MODE") && (d(n = e[r], 0, 8, r), R = n), e.hasOwnProperty(r = "EXPONENTIAL_AT") && ((n = e[r]) && n.pop ? (d(n[0], -g, 0, r), d(n[1], 0, g, r), _ = n[0], D = n[1]) : (d(n, -g, g, r), _ = -(D = n < 0 ? -n : n))), e.hasOwnProperty(r = "RANGE"))
                    ...
                    return k(arguments, E.lt)
                }, C.minimum = C.min = function() {
                    return k(arguments, E.gt)
                }, C.random = function() {
                    ...
                    for (var e = 1, r = arguments, n = new C(r[0]); e < r.length;) n = n.plus(r[e++]);
                    return n
                }, b = function() {
                    var e = "0123456789";
                    ...
                    return function(t, i, o, s, u) {
                        var f, l, c, a, h, g, p, m, d = t.indexOf("."),
                            v = S,
                            N = R;
                        for (d >= 0 && (a = x, x = 0, t = t.replace(".", ""), g = (m = new C(i)).pow(t.length - d), x = a, m.c = r(O(w(g.c), g.e, "0"), 10, o, e), m.e = m.c.length), c = a = (p = r(t, i, o, u ? (f = T, e) : (f = e, T))).length; 0 == p[--a]; p.pop());
                    ...
                    return function(t, i, s, u, c) {
                        var a, h, g, w, m, d, v, N, O, b, y, E, A, S, R, _, D, P = t.s == i.s ? 1 : -1,
                            B = t.c,
                            L = i.c;
                        if (!B || !B[0] || !L || !L[0]) return new C(t.s && i.s && (B ? !L || B[0] != L[0] : L) ? B && 0 == B[0] || !L ? 0 * P : P / 0 : NaN);
                        for (O = (N = new C(P)).c = [], P = s + (h = t.e - i.e) + 1, c || (c = f, h = p(t.e / l) - p(i.e / l), P = P / l | 0), g = 0; L[g] == (B[g] || 0); g++);
                        if (L[g] > (B[g] || 0) && h--, P < 0) O.push(1), w = !0;
                        else {
                            for (S = B.length, _ = L.length, g = 0, P += 2, (m = o(c / (L[0] + 1))) > 1 && (L = e(L, m, c), B = e(B, m, c), _ = L.length, S = B.length), A = _, y = (b = B.slice(0, _)).length; y < _; b[y++] = 0);
                            D = L.slice(), D = [0].concat(D), R = L[0], L[1] >= c / 2 && R++;
                            do {
                                if (m = 0, (a = r(L, b, _, y)) < 0) {
                                    if (E = b[0], _ != y && (E = E * c + (b[1] || 0)), (m = o(E / R)) > 1)
                                        for (m >= c && (m = c - 1), v = (d = e(L, m, c)).length, y = b.length; 1 == r(d, b, v, y);) m--, n(d, _ < v ? D : L, v, c), v = d.length, a = 1;
                                    else 0 == m && (a = m = 1), v = (d = L.slice()).length;
                                    if (v < y && (d = [0].concat(d)), n(b, d, y, c), y = b.length, -1 == a)
                                        for (; r(L, b, _, y) < 1;) m++, n(b, _ < y ? D : L, y, c), y = b.length
                                } else 0 === a && (m++, b = [0]);
                    ...
                    return function(o, u, f, l) {
                        ...
                        if (t.test(a)) o.s = isNaN(a) ? null : a < 0 ? -1 : 1;
                            ...
                            if (!f && (a = a.replace(e, (function(e, r, n) {
                                ...
                                })), l && (c = l, a = a.replace(r, "$1").replace(n, "0.$1")), u != a)) return new C(a, c);
                            if (C.DEBUG) throw Error(s + "Not a" + (l ? " base " + l : "") + " number: " + u);
                            o.s = null
                        }
                        o.c = o.e = null
                    }
                    ...
                    return m(this, new C(e, r))
                }, E.decimalPlaces = E.dp = function(e, r) {
                    var n, t, i, o = this;
                    if (null != e) return d(e, 0, g), null == r ? r = R : d(r, 0, 8), F(new C(o), e + o.e + 1, r);
                    if (!(n = o.c)) return null;
                    if (t = ((i = n.length - 1) - p(this.e / l)) * l, i = n[i])
                        for (; i % 10 == 0; i /= 10, t--);
                    return t < 0 && (t = 0), t
                }, E.dividedBy = E.div = function(e, r) {
                    return n(this, new C(e, r), S, R)
                }, E.dividedToIntegerBy = E.idiv = function(e, r) {
                    return n(this, new C(e, r), 0, 1)
                }, E.exponentiatedBy = E.pow = function(e, r) {
                    var n, t, u, f, c, a, h, g, p = this;
                    if ((e = new C(e)).c && !e.isInteger()) throw Error(s + "Exponent not an integer: " + j(e));
                    if (null != r && (r = new C(r)), c = e.e > 14, !p.c || !p.c[0] || 1 == p.c[0] && !p.e && 1 == p.c.length || !e.c || !e.c[0]) return g = new C(Math.pow(+j(p), c ? 2 - v(e) : +j(e))), r ? g.mod(r) : g;
                    if (a = e.s < 0, r) {
                        if (r.c ? !r.c[0] : !r.s) return new C(NaN);
                        (t = !a && p.isInteger() && r.isInteger()) && (p = p.mod(r))
                    } else {
                        if (e.e > 9 && (p.e > 0 || p.e < -1 || (0 == p.e ? p.c[0] > 1 || c && p.c[1] >= 24e7 : p.c[0] < 8e13 || c && p.c[0] <= 9999975e7))) return f = p.s < 0 && v(e) ? -0 : 0, p.e > -1 && (f = 1 / f), new C(a ? 1 / f : f);
                        x && (f = i(x / l + 2))
                    }
                    for (c ? (n = new C(.5), a && (e.s = 1), h = v(e)) : h = (u = Math.abs(+j(e))) % 2, g = new C(A);;) {
                        if (h) {
                        ...
                        if (u) {
                            if (0 === (u = o(u / 2))) break;
                            h = u % 2
                        } else if (F(e = e.times(n), e.e + 1, 1), e.e > 14) h = v(e);
                        else {
                            if (0 === (u = +j(e))) break;
                            h = u % 2
                        }
                    ...
                    return t ? g : (a && (g = A.div(g)), r ? g.mod(r) : f ? F(g, x, R, undefined) : g)
                }, E.integerValue = function(e) {
                    var r = new C(this);
                    return null == e ? e = R : d(e, 0, 8), F(r, r.e + 1, e)
                }, E.isEqualTo = E.eq = function(e, r) {
                    return 0 === m(this, new C(e, r))
                }, E.isFinite = function() {
                    return !!this.c
                }, E.isGreaterThan = E.gt = function(e, r) {
                    return m(this, new C(e, r)) > 0
                }, E.isGreaterThanOrEqualTo = E.gte = function(e, r) {
                    return 1 === (r = m(this, new C(e, r))) || 0 === r
                    ...
                    var n, t, i, o, s = this,
                        u = s.s;
                    if (r = (e = new C(e, r)).s, !u || !r) return new C(NaN);
                    ...
                    var c = s.e / l,
                        ...
                        g = e.c;
                    if (!c || !a) {
                        if (!h || !g) return h ? (e.s = -r, e) : new C(g ? s : NaN);
                        if (!h[0] || !g[0]) return g[0] ? (e.s = -r, e) : new C(h[0] ? s : 3 == R ? -0 : 0)
                    }
                    ...
                    return h[0] ? G(e, h, a) : (e.s = 3 == R ? -1 : 1, e.c = [e.e = 0], e)
                }, E.modulo = E.mod = function(e, r) {
                    var t, i, o = this;
                    return e = new C(e, r), !o.c || !e.s || e.c && !e.c[0] ? new C(NaN) : !e.c || o.c && !o.c[0] ? new C(o) : (9 == U ? (i = e.s, e.s = 1, t = n(o, e, 0, 3), e.s = i, t.s *= i) : t = n(o, e, 0, U), (e = o.minus(t.times(e))).c[0] || 1 != U || (e.s = o.s), e)
                    ...
                    var n, t = this,
                        i = t.s;
                    if (r = (e = new C(e, r)).s, !i || !r) return new C(NaN);
                    ...
                    var o = t.e / l,
                        ...
                        c = e.c;
                    if (!o || !s) {
                        if (!u || !c) return new C(i / 0);
                        if (!u[0] || !c[0]) return c[0] ? e : new C(u[0] ? t : 0 * i)
                    }
                    ...
                    var n, t, i, o = this;
                    if (null != e && e !== !!e) return d(e, 1, g), null == r ? r = R : d(r, 0, 8), F(new C(o), e, r);
                    if (!(n = o.c)) return null;
                    ...
                    if (0 == (f = Math.sqrt(+j(s))) || f == 1 / 0 ? (((r = w(u)).length + l) % 2 == 0 && (r += "0"), f = Math.sqrt(+r), l = p((l + 1) / 2) - (l < 0 || l % 2), t = new C(r = f == 1 / 0 ? "1e" + l : (r = f.toExponential()).slice(0, r.indexOf("e") + 1) + l)) : t = new C(f + ""), t.c[0])
                        for ((f = (l = t.e) + c) < 3 && (f = 0);;)
                            if (o = t, t = a.times(o.plus(n(s, o, c, 1))), w(o.c).slice(0, f) === (r = w(t.c)).slice(0, f)) {
                                if (t.e < l && --f, "9999" != (r = r.slice(f - 3, f + 1)) && (i || "4999" != r)) {
                                    +r && (+r.slice(1) || "5" != r.charAt(0)) || (F(t, t.e + S + 2, 1), e = !t.times(t).eq(s));
                                    break
                                }
                                if (!i && (F(o, o.e + S + 2, 0), o.times(o).eq(s))) {
                                    t = o;
                                    break
                                }
                                c += 4, f += 4, i = 1
                            }
                    return F(t, t.e + S + 1, R, e)
                }, E.toExponential = function(e, r) {
                    return null != e && (d(e, 0, g), e++), M(this, e, r, 1)
                }, E.toFixed = function(e, r) {
                    return null != e && (d(e, 0, g), e = e + this.e + 1), M(this, e, r)
                    ...
                    var r, t, i, o, u, f, c, h, g, p, m, d, v = this,
                        N = v.c;
                    if (null != e && (!(c = new C(e)).isInteger() && (c.c || 1 !== c.s) || c.lt(A))) throw Error(s + "Argument " + (c.isInteger() ? "out of range: " : "not an integer: ") + j(c));
                    if (!N) return new C(v);
                    for (r = new C(A), g = t = new C(A), i = h = new C(A), d = w(N), u = r.e = d.length - v.e - 1, r.c[0] = a[(f = u % l) < 0 ? l + f : f], e = !e || c.comparedTo(r) > 0 ? u > 0 ? r : g : c, f = B, B = 1 / 0, c = new C(d), h.c[0] = 0; p = n(c, r, 0, 1), 1 != (o = t.plus(p.times(i))).comparedTo(e);) t = i, i = o, g = h.plus(p.times(o = g)), h = o, r = c.minus(p.times(o = r)), c = o;
                    return o = n(e.minus(t), i, 0, 1), h = h.plus(o.times(g)), t = t.plus(o.times(i)), h.s = g.s = v.s, m = n(g, i, u *= 2, R).minus(v).abs().comparedTo(n(h, t, u, R).minus(v).abs()) < 1 ? [g, i] : [h, t], B = f, m
                }, E.toNumber = function() {
                    return +j(this)
                }, E.toPrecision = function(e, r) {
                    return null != e && d(e, 1, g), M(this, e, r, 2)
                }, E.toString = function(e) {
                    var r, n = this,
                        t = n.s,
                        i = n.e;
                    return null === i ? t ? (r = "Infinity", t < 0 && (r = "-" + r)) : r = "NaN" : (null == e ? r = i <= _ || i >= D ? N(w(n.c), i) : O(w(n.c), i, "0") : 10 === e ? r = O(w((n = F(new C(n), S + i + 1, R)).c), n.e, "0") : (d(e, 2, T.length, "Base"), r = b(O(w(n.c), i, "0"), 10, e, t, !0)), t < 0 && n.c[0] && (r = "-" + r)), r
                }, E.valueOf = E.toJSON = function() {
                    return j(this)
                }, E._isBigNumber = !0, E[Symbol.toStringTag] = "BigNumber", E[Symbol.for("nodejs.util.inspect.custom")] = E.valueOf, null != r && C.set(r), C
            }();
            r.a = b
        }
    }
]);
//# sourceMappingURL=3.967323fc.chunk.js.map