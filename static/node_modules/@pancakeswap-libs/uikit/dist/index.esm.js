...
var Icon$q = function(_a) {
    ...
    return (React.createElement(Svg, __assign({
        ...
        React.createElement("image", {
            width: "20",
            height: "20",
            href: isDark ? "/images/DarkLogo.png" : "/images/RedLogo.png"
        })));
};
    ...
    return (React.createElement(Svg, {
        ...
        React.createElement("g", {
            ...
            React.createElement("path", {
                "fill-rule": "evenodd",
                "clip-rule": "evenodd",
                d: "M60.5002 0L36 61.593H55.075L81 0H60.5002Z",
                fill: "#A1D2FF"
            }),
            React.createElement("mask", {
                    id: "mask0",
            ...
            React.createElement("path", {
                "fill-rule": "evenodd",
                "clip-rule": "evenodd",
                d: "M4 0H26.7694L56 62.5864H34.6168L4 0Z",
                fill: "#C7E6FF"
            })),
        React.createElement("defs", null,
            React.createElement("filter", {
                ...
                React.createElement("feColorMatrix", { in: "SourceAlpha",
                    type: "matrix",
...
var ChainModal = function(_a) {
    ...
    var networks = [{
        ...
        },
        {
            title: "Ethereum",
            id: "eth",
            icon: React.createElement(Icon$1f, {
                width: "32px"
            }),
            connectorId: "injected",
    ...
    return React.createElement(Modal, {
        ...
        onDismiss: onDismiss
    }, networks.map(function(entry, index) {
        return (React.createElement(Button, {
                fullWidth: true,
                variant: "tertiary",
                onClick: function() {
...
var useWalletModal = function(login, logout, account, selectedChain) {
    ...
    return {
        ...
        onPresentChainToggleModal: onPresentChainToggleModal
    };
};
...
var ChainToggle = function(_a) {
    var account = _a.account,
        _b = _a.isBinance,
        isBinance = _b === void 0 ? true : _b;
    var onPresentChainToggleModal = useWalletModal(function() {
        return null;
    }, function() {
        return null;
    }, account).onPresentChainToggleModal;
    return (React.createElement("div", {
        style: {
            marginLeft: 10,
            marginRight: 10
        }
    }, isBinance ? (React.createElement(Icon$b, {
        height: 40,
        width: 40,
        onClick: function() {
            onPresentChainToggleModal();
        }
    })) : (React.createElement(Icon$1f, {
        height: 40,
        width: 40,
        onClick: function() {
            onPresentChainToggleModal();
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, {
            ...
            React.createElement(Flex, null,
                React.createElement(ChainToggle, {
                    account: account,
                    isBinance: isBinance
                }),
